...
public class iTunesGUI extends JFrame implements ActionListener, ListSelectionListener
{
	...
	private iTunesAD allinone=new iTunesAD();
	private Thread thrAudio;
	private Boolean playingwav=false;
...
//			lbSong.setText(respuesta);
			String name = tfSong.getText();
			if(name.endsWith(".wav")){
				allinone.play("music/" + name);
				playingwav=true;
			}
			taSongs.setEnabled(false);
		}
...
//				Obtener lista de songs
				String directorio[]=allinone.obtenerSongs();
